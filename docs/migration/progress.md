...
| Main              |     22 | 1708 | **완료** | 진행중   | 헤더·카드 완료. 스와이퍼/배너/공지/쇼핑 남음                     |
...
#### ⚠️ main에 남은 것 (2/3 · 3/3)

| 단계 | 범위                                                                              |
| ---- | --------------------------------------------------------------------------------- |
| 2/3  | 카드 그리드(`useMainCardLayout` 242 LOC) + 카드 5종 + A-PAY 2카드 + recharts 도넛 |
| 3/3  | 메뉴 스와이퍼(swiper) · 광고 배너 · 공지 Top3 · 쇼핑 마케팅 동의 바텀시트         |
