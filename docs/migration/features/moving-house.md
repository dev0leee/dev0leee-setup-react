...
**Repair 도메인도 같은 클래스를 쓴다** → 함께 결정한다. → `MH-Q11`
...
| 항목                               | 상태                                                                        |
| ---------------------------------- | --------------------------------------------------------------------------- |
| `border-bg-gray` (MH3 textarea)    | 🔴 **미생성 클래스** (`broken-styles.md` §5). Repair와 공통 → `MH-Q11`      |
...
| MH-Q11 | `border-bg-gray`가 미생성 클래스다(현재 기본 회색). 어떤 토큰으로 정하는가 (**Repair와 함께**)                                            | MH3      |
...
| MH3 textarea 테두리 색 (`border-bg-gray` 미생성 → 기본 회색)           |
