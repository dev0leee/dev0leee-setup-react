...
> **이 문서는 다른 문서와 성격이 다르다.** 리서치를 돌렸지만 "JS 문법 컨벤션"은 2026년 커뮤니티에서
> 논쟁거리가 아니었다 — 검색 결과 대부분이 입문 튜토리얼이었다. 그래서 여기 규칙들은 커뮤니티 논쟁이 아니라
> **(a) 이 레포의 린터/포매터 설정이 이미 강제하는 것**과 **(b) ES2023이 실제로 제공하는 것**에서 나온다.
> 확신의 근거가 다르니 그렇게 읽는다.
