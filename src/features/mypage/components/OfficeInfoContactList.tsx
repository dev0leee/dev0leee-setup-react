 ...
 *
 * ⚠️ 레거시 `text-brand-primary-50`·`-100`은 config에 없는 클래스라 색이 적용되지 않는다.
 * 제목·전화번호 모두 상속색 `#111927`로 렌더된다 → 같은 값의 토큰으로 표현했다.
 *
          ...
          {officeContactList.map((item, index) => {
            return (
              ...
              >
                ...
                <a
                  className="flex items-center justify-end gap-[2px] pretendard-15Regular text-neutral-b-gray-900 underline underline-offset-4"
                  href={`tel:${item.phone ?? ''}`}
                >
